...
class SingleEyeFitter(object):
    ...
    def __init__(self, focal_length, pupil_radius, initial_eye_z, image_shape=(640, 480)):
        ...
        self.projected_eye_center = None  # reserved for numpy array (2,1). Centre coordinate in numpy indexing frame.
        self.eye_center = None  # reserved for (3,1) numpy array. 3D centre coordinate in camera frame
    ...
    def unproject_single_observation(self, ellipse, mask=None, threshold=0.5):
